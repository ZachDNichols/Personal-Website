...
<div class="flex flex-row items-start justify-center m-20 mb-10">
    ...
    <div class="flex flex-col items-start justify-center w-1/2 m-20">
...
<div class="flex flex-col items-center justify-center w-full mb-0">
    <h2 class="text-6xl font-bold m-4 mb-1">Videos</h2>
    <p>Sometimes I do this YouTube thing. Here are my latest uploads!</p>
</div>
