...
<div class="flex flex-col items-center dark:text-white">
    ...
    <div class="flex flex-col items-center justify-center text-center w-11/12 mt-10 row hidden-animation">
        ...
        <div class="flex flex-col items-center text-center justify-center w-full mb-4 hidden-animation">
            <h2 class="font-bold w-full text-3xl mt-2 mb-2 hidden-animation">SOCIALS</h2>
            <p>Feel free to follow me on social media!</p>
        </div>
        <div class="flex flex-wrap items-center justify-center align-middle gap-2 hidden-animation">
        ...
        <div class="flex flex-row items-left justify-start ml-0 border-4 border-primary rounded-xl bg-primary p-2 mt-4 text-white hidden-animation">
            <svg role="img" width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><title>Discord</title>
        ...
        <div class="flex flex-col items-center justify-center w-full mt-4 text-center hidden-animation">
...
<div class="flex flex-col items-center justify-center w-11/12 mb-0 dark:text-white hidden-animation">
...
<div class="flex flex-col w-full dark:text-white justify-evenly hidden-animation">
...
<div class="flex flex-row items-center justify-center w-full dark:text-white hidden-animation"> 
    <a class="hidden-animation mb-4 text-2xl font-bold text-white bg-primary rounded-xl p-2 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl hover:translate-y-[-1.5] uppercase" target="_blank" href="https://www.youtube.com/@zachdnichols">See more on YouTube</a>
</div>

<div class="flex flex-col items-center justify-center w-full mb-4 dark:text-white hidden-animation">
    <h2 class="text-6xl font-bold m-4 text-center uppercase">Coding Projects</h2> 
    <p>I do a little coding... Here are my favorites!</p>
</div>
<div class="flex flex-col w-full mb-20 justify-center align-center items-center text-left dark:text-white hidden-animation">
    <CodingProject 
